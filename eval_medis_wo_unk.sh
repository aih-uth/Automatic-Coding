...
python eval_bert_w_adacos.py --exp_name bert_adacos_medis --save_path bert_adacos_medis
python eval_bert_w_adacos.py --exp_name bert_adacos_medis_aug --save_path bert_adacos_medis_aug
